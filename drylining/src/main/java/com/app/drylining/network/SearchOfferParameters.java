...
public class SearchOfferParameters implements Serializable
{
    private String searchCountry, searchCity, searchRange, searchProperty, searchRoom, searchGarage, searchCityLocation;
    ...
    public SearchOfferParameters(String city, String property, String garage, int min, int max, String location) {
    ...
    public SearchOfferParameters(String city, String property, String garage) {
        this.searchCity = city;
        /*this.searchRange = range;*/
        this.searchProperty = property;
        /*this.searchRoom = room;*/
    ...
    public String getPostContent() {
        ...
        postContent="countryName=" + searchCountry + "&cityName=" + searchCity + "&propertyType=" + searchProperty + "&garageType=" + searchGarage;
