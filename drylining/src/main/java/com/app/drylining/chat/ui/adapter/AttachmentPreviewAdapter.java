...
public class AttachmentPreviewAdapter extends BaseListAdapter<File> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(DRYLINING.getInstance())
                .load(attachmentFile)
//                .override(ResourceUtils.getDimen(R.dimen.chat_attachment_preview_size), ResourceUtils.getDimen(R.dimen.chat_attachment_preview_size))
